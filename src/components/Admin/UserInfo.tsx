...
import { Dashboard, UserList, UserManagementList, TransactionDetail } from "../Common/RouteConst";
...
import { getContractList } from "../../services/user";
...
const UserInfo = ():any => {
  ...
  const fetchcontractList = () => {
    getContractList(userAlias, current > 0 ? current - 1 : 0, page, "all").then(
      (res: any) => {
  ...
  const columns: object[] = [
    {
      ...
      render: (text: any, value:any) => {
        return <Typography.Text ellipsis={true} style={{ maxWidth: 150 }} className="hyperLink overflowText" onClick={() => {
    ...
    },
    {
      ...
      sorter: false,
      render: (text: any) => {
        return <Typography.Text ellipsis={true} style={{ width: 150 }}>
           <Popover content={text?.email}>
          {text?.email}
      ...
      render: (text: string) => {
        return (
          <span className="status capitalize">
            <span
              className={(text && CONTRACT_STATUS[text]) ? CONTRACT_STATUS[text]
                .toLowerCase()
                .split(" ")
                .join("_") : ''}
            >
    ...
    },
    {
      ...
      render: (text: string, value: any) => {
        return <b>{value?.currency + " " + text}</b>;
      },
    },

    {
      ...
      render: (_text: string) => {
        return (
          <div className="text-center" onClick={()=>{navigate(TransactionDetail+'/'+_text)}}>
            <Image src={View} alt="view" preview={false} className="cursor" height={16} width={22} />
          </div>
        );
      },
    },
  ...
  return (
    <div className="m-main-body-section scrollbar-container">
      ...
      >
            <Row gutter={{ xs:25, sm: 25, md: 25, lg: 25 }} >
              <Col xs={24} sm={24} md={24} lg={15} xl={15}>
                <div className="bg-admin-card p-4" >
                  <Col span={24}>
                    <div className="d-flex">
                      <Col span={24} className="mr-25">
                        ...
                        {/* <div className="subtext_white opacity-50 mt-3 ">
                          Username
                        </div> */}
                        <hr className="mt-4" />
                      </Col>
                    ...
                    <div className="subtext_white mt-3 d-flex">
                          ...
                          <div className="m-0">
                          <div className="px-1 bluecard-flag ms-0">
                            <span>
                              {userDetails?.countryAlias ? (
                                <span className={`fi fi-${userDetails?.countryAlias.toLowerCase()}`} />
                              ) : (
                  ...
                  {/* <div
                    className="w-100 text-right mt--35"
                    onClick={() => {
                      setdownloadModal(true);
                    }}
                  >
                    <Button className="downloadCard ">Download</Button>
                  </div> */}
                </div>
              </Col>
              ...
              <Row gutter={{ xs:25, sm: 25, md: 25, lg: 25 }} >
                ...
                {KycData?.kybStatus == "VERIFIED" ? (
                  <div className="d-flex mt-2 verified py-1 px-3">
                    ...
                    <div className="px-2 m-auto">Verified</div>
                  </div>
                ) : (
            ...
            <div className="titleText mt-5 mb-4">Transactions</div>
