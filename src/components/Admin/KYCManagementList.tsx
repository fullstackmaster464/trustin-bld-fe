import {
  ...
  import { AdminKYCDetail } from "../Common/RouteConst";
  ...
  const [index, setIndex] = useState<any>();
    ...
    const handleChange = (value: number) => {
      ...
      if (typeof searchedKey === "object" && Object.keys(searchedKey)?.length > 0) {
        ...
        fetchKybList(1, value, tab, {}, typeOfEntity)
      }
    };
    const onTabChange = (tabValue: string) => {
      ...
      if (Object.keys(searchedKey)?.length > 0) {
        ...
        fetchKybList(1, page, tabValue, {}, typeOfEntity);
      }
    };  
    const onChangePage = (pageno: number) => {
      ...
      if (typeof searchedKey === "object" && Object.keys(searchedKey)?.length > 0) {
        ...
        fetchKybList(pageno, page, tab, {}, typeOfEntity);
      }
    };
    ...
    const columns: object[] = [
      {
        ...
        render: (text:any,values:any) =>{    
          ...
          onClick={() => {
            navigate(AdminKYCDetail + '/' + values?.userAlias)
          }}>
            <Tooltip
          ...
          return (
            <div className="d-flex">
              ...
              <Image
                ...
                onClick={()=>{navigate(AdminKYCDetail+'/'+text)}}
              />
              </Col>
              <Col>
               <Image
    ...
    useEffect(() => {
      fetchKybList(current, page, "all", {}, typeOfEntity);
    }, []);
    const onSearch = (e: string, currentPage: number, page: number) => {     
      if (e) {
        setLoading(true);
        setSearchedKey(e);
        const reqBody = { key: e, typeOfEntity: "INDIVIDUAL" };
        searchList(
        ...
        setSearchedKey('')
        fetchKybList(1, page, tab, {}, typeOfEntity);
      }
    }
    ...
    const handleApplyFilter = (filterOptions: any, pageNo: any, limit: any) => {
      ...
      if (
        ...
        if (filterOptions) {
          reqbody = { typeOfEntity: 'INDIVIDUAL' };
        }
    ...
    const handleResetAllClick = () => {
      ...
      setCurrent(1);
      setPage(10);
      fetchKybList(1, 10, "all", {}, "INDIVIDUAL");
    }
            ...
            <div className="d-flex">
              ...
              <div className="ml-5">
                ...
                <Breadcrumb separator=">">
                  ...
                  <Breadcrumb.Item>KYC management</Breadcrumb.Item>
                </Breadcrumb>
              </div>
            </div>
          }
