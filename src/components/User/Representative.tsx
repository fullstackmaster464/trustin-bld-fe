...
const Representative = () => {
  return (
    <div className="scroll">
      <div className="subText_small my-4">Passport Front</div>
      <Row className="my-4">
      ...
      <hr className="grayHr" />
      <div className="subText_small my-4">Passport Back</div>
      <Row className="my-4">
        <Col span={3} className="success">
          <Image src={Success} alt="company" preview={false} className="px-1" />
          Verified
      ...
      <hr className="grayHr" />
      <div className="subText_small my-4">Address Proof</div>
      <Row className="my-4">
        <Col span={3} className="success">
          <Image src={Success} alt="company" preview={false} className="px-1" />
          Verified
