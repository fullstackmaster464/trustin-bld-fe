...
import { approvedTrusteeTxn, searchTrusteeTxn } from "../../services/trustee";
    ...
    allLocale: {
      emptyText: (
        <>
          ...
          <p className="nodata my-5">No approved transaction found</p>
        </>
      ),
    },
  };
        ...
        return (
          <>
            <div className="text-center d-flex gap-3">
              <Image src={View} alt="view" preview={false} className="cursor icon-default-size" onClick={()=>{navigate(TransactionDetail+ "/" + values?.aliasName,{state:{pagefrom:'transaction'}})}} />
