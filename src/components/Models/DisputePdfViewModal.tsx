...
const DisputePdfViewModal = ({isverifyVisible,setverifyVisible,imagUrl,setImagUrl}: PdfPreviewModalProps) => {
     ...
     <div>
         ...
         >
             ...
             <Document 
                 ...
                 loading=""
             >
                 <Page pageNumber={pageNumber} onRenderSuccess={()=>setLoading(false)} />
             </Document>
             {numPages > 1 && (
             <div className='d-flex justify-content-center mt-3'>
                 ...
                 <Button
                 type="primary"
                 className="docudownloadBtn mt-3"
                 onClick={() => {
                   downloadFile();
...
export default DisputePdfViewModal
